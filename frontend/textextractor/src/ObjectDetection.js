...
const uploadAndExtractObjects = async (file) => {
...
const handleSavePhoto = async (imageSrc) => {
  ...
  await uploadAndExtractObjects(file); // Trigger detection with the captured image
...
const handleFileChange = async (event) => {
  ...
  if (file){
    await(uploadAndExtractObjects(file));
  }
}
